...
# Create a hexagonal layer using 'balita_stunting' as elevation
hexagon_layer = pdk.Layer(
    "HexagonLayer",
    data=filtered_data,
    get_position='[lon, lat]',
    radius=1000,  # Set your desired radius for the hexagons
    elevation_scale=4,  # You can adjust this value as needed
    elevation_range=[0, 2000000],  # Set your desired elevation range
    get_elevation='balita_stunting',  # Use 'balita_stunting' column for elevation
    pickable=True,
    extruded=True,
)

# Create a PyDeck Deck with the hexagonal layer
deck = pdk.Deck(
